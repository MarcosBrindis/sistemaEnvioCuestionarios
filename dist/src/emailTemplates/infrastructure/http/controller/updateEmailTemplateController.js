...
exports.updateEmailTemplateController = void 0;
const errorHandler_1 = require("../../../../core/middleware/errorHandler");
const updateEmailTemplateController = (updateEmailTemplate) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        ...
        const template = yield updateEmailTemplate.execute(id, {
            subject: asunto,
            body: cuerpo,
...
exports.updateEmailTemplateController = updateEmailTemplateController;
