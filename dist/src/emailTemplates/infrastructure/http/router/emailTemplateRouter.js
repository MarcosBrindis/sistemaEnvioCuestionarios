...
const createEmailTemplateController_1 = require("../controller/createEmailTemplateController");
const getEmailTemplatesController_1 = require("../controller/getEmailTemplatesController");
const getEmailTemplateByIdController_1 = require("../controller/getEmailTemplateByIdController");
const updateEmailTemplateController_1 = require("../controller/updateEmailTemplateController");
const deleteEmailTemplateController_1 = require("../controller/deleteEmailTemplateController");
 ...
 */
router.post('/', (0, createEmailTemplateController_1.createEmailTemplateController)(dependencies_1.createEmailTemplate));
/**
 * @swagger
 * /api/templates-correo:
 *   get:
 ...
 */
router.get('/', (0, getEmailTemplatesController_1.getEmailTemplatesController)(dependencies_1.getEmailTemplates));
/**
 * @swagger
 ...
 */
router.get('/:id', (0, getEmailTemplateByIdController_1.getEmailTemplateByIdController)(dependencies_1.getEmailTemplateById));
/**
 * @swagger
 * /api/templates-correo/{id}:
 *   put:
 ...
 *         description: Not found
 */
router.put('/:id', (0, updateEmailTemplateController_1.updateEmailTemplateController)(dependencies_1.updateEmailTemplate));
/**
 * @swagger
 * /api/templates-correo/{id}:
 *   delete:
 ...
 */
router.delete('/:id', (0, deleteEmailTemplateController_1.deleteEmailTemplateController)(dependencies_1.deleteEmailTemplate));
