...
exports.updateTipoCorreoController = void 0;
const errorHandler_1 = require("../../../../core/middleware/errorHandler");
const updateTipoCorreoController = (updateTipoCorreo) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        ...
        const tipoCorreo = yield updateTipoCorreo.execute(id, tipo);
        res.status(200).json({
            data: {
                type: 'tipos-correo',
...
exports.updateTipoCorreoController = updateTipoCorreoController;
