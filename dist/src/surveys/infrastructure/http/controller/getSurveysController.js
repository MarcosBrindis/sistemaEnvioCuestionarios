...
exports.getSurveysController = void 0;
const errorHandler_1 = require("../../../../core/middleware/errorHandler");
const getSurveysController = (getSurveys) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (busqueda)
            params.search = String(busqueda);
        const result = yield getSurveys.execute(params);
...
exports.getSurveysController = getSurveysController;
