...
exports.getPublicSurveyByUuidController = void 0;
const errorHandler_1 = require("../../../../core/middleware/errorHandler");
const getPublicSurveyByUuidController = (getPublicSurveyByUuid) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const payload = yield getPublicSurveyByUuid.execute(uuid);
        if (!payload) {
...
exports.getPublicSurveyByUuidController = getPublicSurveyByUuidController;
