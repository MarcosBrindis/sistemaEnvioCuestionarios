...
exports.createTypeQuestionController = void 0;
const errorHandler_1 = require("../../../../core/middleware/errorHandler");
const createTypeQuestionController = (createTypeQuestion) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        ...
        const typeQuestion = yield createTypeQuestion.execute({ nombre });
...
exports.createTypeQuestionController = createTypeQuestionController;
