...
exports.swaggerUiSetup = exports.swaggerSpec = void 0;
const swagger_jsdoc_1 = __importDefault(require("swagger-jsdoc"));
const swagger_ui_express_1 = __importDefault(require("swagger-ui-express"));
const path_1 = __importDefault(require("path"));
const publicApiUrl = (_a = process.env.PUBLIC_API_URL) === null || _a === void 0 ? void 0 : _a.trim();
const options = {
    definition: {
        openapi: "3.0.0",
        info: {
    ...
    apis: [
        ...
        path_1.default.join(process.cwd(), "src/**/*.ts"),
        // Produccion (Docker): anotaciones en JavaScript compilado
        path_1.default.join(process.cwd(), "dist/**/*.js"),
    ],
};
