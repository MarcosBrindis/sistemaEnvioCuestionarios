...
import { importarMiembrosController } from '../controller/importarMiembrosController';
import { buscarEgresadosController } from '../controller/buscarEgresadosController';
 ...
 *                           example: 2
 */
router.post('/grupos/:id/miembros/importar', importarMiembrosController(dependencies.importarMiembrosPorFiltro));
/**
 * @openapi
 * /api/egresados:
 *   get:
 ...
 *                       type: integer
 */
router.get('/egresados', buscarEgresadosController(dependencies.buscarEgresadosPorFiltro));
